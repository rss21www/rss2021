...
<table width="40%"> <tr>
<td style="width: 20%; text-align: center;"><a href="100"><img src="{{ site.baseurl }}/images/paper_link.png"
...
<td style="width: 20%; text-align: center;"><a href="https://github.com/MIT-SPARK/Kimera-VIO
https://github.com/MIT-SPARK/Kimera-Semantics"><img src="{{ site.baseurl }}/images/software_link.png"
width = "50"  height = "60"/> </a> </td>
...
<table width="100%"><tr><td style="width: 30%; text-align: center;"><a href="{{ site.baseurl }}/program/papers/78"> <img src="{{ site.baseurl }}/images/previous_icon.png" width = "120"  height = "90"/> </a> </td>
